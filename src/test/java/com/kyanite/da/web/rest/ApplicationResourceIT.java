...
import com.kyanite.da.repository.ApplicationRepository;
...
class ApplicationResourceIT {
    ...
    private static final Instant DEFAULT_URL = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_URL = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Application createEntity(EntityManager em) {
        Application application = new Application().name(DEFAULT_NAME).url(DEFAULT_URL);
        return application;
    }
    ...
    public static Application createUpdatedEntity(EntityManager em) {
        Application application = new Application().name(UPDATED_NAME).url(UPDATED_URL);
        return application;
    }
    ...
    void putNewApplication() throws Exception {
        ...
        updatedApplication.name(UPDATED_NAME).url(UPDATED_URL);
    ...
    void partialUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.url(UPDATED_URL);
    ...
    void fullUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.name(UPDATED_NAME).url(UPDATED_URL);
